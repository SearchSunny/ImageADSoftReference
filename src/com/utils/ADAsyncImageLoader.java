...
public class ADAsyncImageLoader {
     ...
     * @return
     */
    public Drawable loadDrawable(final String imageUrl,final String ADid, final ImageCallback imageCallback){
        ...
        executorService.execute(new Runnable() {
            @Override
            public void run() {
                Drawable drawable = loadImageFromUrl(ctx, imageUrl,"ad_img_"+ADid+".png");
